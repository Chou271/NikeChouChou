...
import * as ActionType2 from '../ListProduct/module/Contant/contants'
import * as action2 from '../ListProduct/module/Actions/actions'
import API from '../../Axios/API'
import { useDispatch, useSelector } from 'react-redux'
import { Grid, Hidden } from '@mui/material'
import ProductImages from './DetailProductComponent/productImages'
import ProductMain from './DetailProductComponent/productMain'
            ...
            <div>
                {isLoading ?
                    <div>
                        <Hidden mdUp>
                            {/* product image */}
                            <ProductImages detailProduct={dataLazyLoading} index={0} />
                        </Hidden>
                    ...
                    <div>
                        {detailProduct &&
                            <div>
                                <Hidden mdUp>
                                    {/* product image */}
                                    <ProductImages detailProduct={detailProduct} index={index} />
                                </Hidden>
                                <Grid container spacing={2}>
                                    <Hidden smDown>
                                        <Grid item sm={12} md={8}>
